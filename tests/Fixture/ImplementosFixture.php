 ...
 *
 */
class ImplementosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'eixos' => ['type' => 'float', 'length' => null, 'precision' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
        'placa' => ['type' => 'string', 'length' => 7, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'renavan' => ['type' => 'string', 'length' => 45, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'antt' => ['type' => 'string', 'length' => 45, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        '_indexes' => [
            'fk_implementos_cidades1_idx' => ['type' => 'index', 'columns' => ['cidade_id'], 'length' => []],
            'fk_implementos_motoristas1_idx' => ['type' => 'index', 'columns' => ['motorista_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_implementos_cidades1' => ['type' => 'foreign', 'columns' => ['cidade_id'], 'references' => ['cidades', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'fk_implementos_motoristas1' => ['type' => 'foreign', 'columns' => ['motorista_id'], 'references' => ['motoristas', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
