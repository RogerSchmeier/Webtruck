...
class FornecedoresFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'telefone' => ['type' => 'string', 'length' => 10, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'fk_fornecedores_cidades1_idx' => ['type' => 'index', 'columns' => ['cidade_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'endereco_UNIQUE' => ['type' => 'unique', 'columns' => ['endereco'], 'length' => []],
            'fk_fornecedores_cidades1' => ['type' => 'foreign', 'columns' => ['cidade_id'], 'references' => ['cidades', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
